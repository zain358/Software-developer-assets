...
export const EXPERIENCE: Experience[] = [
  {
    ...
    company: "Japfa Comfeed India",
    description: [
      "Built cross-platform mobile applications using Flutter and Dart, improving UI responsiveness.",
      "Integrated REST APIs and processed JSON data to enable dynamic app functionality.",
      "Planned and executed multiple responsive UI screens for better user experience.",
      "Collaborated with team members to test, debug, and optimize application performance.",
    ],
    skills: [
      SkillNames.FIREBASE,
      SkillNames.GIT,
  ...
  },
  {
    ...
    company: "MindMatrix",
    description: [
      "Completed an industry-aligned internship in Android App Development using Generative AI, rated 'Excellent.'",
      "Built Android applications using Kotlin and Jetpack Compose with Firebase integration for auth and data storage.",
      "Utilized Android Studio, Google Cloud Labs, and Google AI Studio to explore and implement GenAI capabilities.",
      "Practiced end-to-end development workflows including UI/UX design, prototyping, debugging, and iterative enhancements.",
    ],
    skills: [
      SkillNames.FIREBASE,
      SkillNames.GCP,
